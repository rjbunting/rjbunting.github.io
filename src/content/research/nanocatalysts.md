...
This gave a total reaction rate for the whole nanoparticle catalyst.
  ...
  <figure style="margin:0 auto 1rem auto;max-width:820px;text-align:center;">
    ...
    <figcaption style="margin-top:0.6rem;font-style:italic;font-size:0.95rem;">Classification of active sites from molecular dynamics trajectories using pairwise similarity kernels</figcaption>
  </figure>
